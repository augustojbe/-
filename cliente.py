...
class Chat:
    ...
    def janela(self):
        ...
        self.caixa_texto.place(relx=0.05, rely=0.1, width=700, height=600)
    ...
    def conecta(self):
        while True:
            recebido = self.clint.recv(1024)
            if recebido == b'SALA':
                self.clint.send(self.sala.encode())
                self.clint.send(self.nome.encode())
            else:
                try:
    ...
    def enviarMensagem(self):
        ...
        self.clint.send(mensagem.encode())
